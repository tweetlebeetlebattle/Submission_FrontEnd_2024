                ...
                <div style={modalOverlayStyle}>
                    <div style={modalStyle}>
                        ...
                        <div style={buttonContainerStyle}>
                            <button style={buttonStyle} onClick={handleRegisterLogin}>Register/Login</button>
                            <button style={buttonStyle} onClick={handleContinueAsGuest}>Continue as Guest</button>
                        </div>
                    </div>
                </div>
            )}
